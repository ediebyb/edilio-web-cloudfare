    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          {/* Columna izquierda: Fotos arriba + CTA al medio + Métricas abajo */}
          <motion.div
            ...
            <div className="flex flex-col items-center gap-4 w-full">
              ...
              <div className="relative">
                <img
                  ...
                  className="w-56 h-56 md:w-48 md:h-48 lg:w-64 lg:h-64 rounded-3xl object-cover shadow-2xl"
                />
              ...
              <img
                ...
                className="w-48 h-48 md:w-40 md:h-40 lg:w-56 lg:h-56 rounded-3xl object-contain shadow-2xl bg-[#05121F] p-4"
              />
            </div>
